    ...
    */
    {
        ...
        std::cout << "range-loop: ";
        for (const auto &mem : di) // range-based loop access
        {
            std::cout << mem << ' ';
        }
        std::cout << std::endl;
...
Notes:
    ...
    *) std::initializer should be const (since input passed will be mostly rvalue) and take it as reference (otherwise unnecessary initializer_list will get copied during constructor invoke)
*/